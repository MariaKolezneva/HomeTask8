...
public class SummaryPage {
    private static final SelenideElement ALGO_PERFORMANCE = $x("//div[@class='app-title flex-1 widget__header' and text()='Algo Performance']");
    private static final SelenideElement WIDGET = $x("(//div[@class='widget-icon' and @title='Expand'])[2]");
